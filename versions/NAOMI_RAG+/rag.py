...
def get_mi_retrievers(embeddings):
    """
    Load the FAISS indexes used for NAOMI-RAG / NAOMI-RAG+.

    Internally this still points to your MI obesity corpus indexes on disk.
    """
...
def format_context(results):
    """
    Format retrieved therapist examples for insertion into the prompt.
    """
    examples = []
    example_id = 1
...
def format_retrieval(results):
    """
    Debug-friendly rendering of raw retrieval hits.
    """
    chunks = []
    example_id = 1
